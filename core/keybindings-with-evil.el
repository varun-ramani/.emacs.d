...
(general-define-key
 ...
 "SPC o a" '(:which-key "Agenda")
 "SPC o t" '(org-todo :which-key "Cycle todo")
 "SPC o a a" '(org-agenda-file-to-front :which-key "Add this file to agenda")
 "SPC o a v" '(org-agenda-list :which-key "View agenda")

 "SPC o a t" '(org-time-stamp :which-key "Set timestamp")
 "SPC o a d" '(org-deadline :which-key "Set deadline")
 "SPC o a s" '(org-schedule :which-key "Schedule event")

 "SPC o a r" '(org-agenda-redo :which-key "Refresh agenda"))
